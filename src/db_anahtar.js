...
function DB_Anahtar() {
     ...
     * @returns {Promise}
     */
    function f_db_anahtar_key(_anahtarKelime) {
    ...
    function f_db_anahtar_ekle(_anahtarKelime) {
    ...
    function f_db_anahtar_index_ekle_urun(anahtar_id, urun_id) {
    ...
    function f_db_anahtar_index_sil_urun(anahtar_id, urun_id) {
    ...
    function f_db_anahtar_index_ihale(anahtar_id) {
        return result.dbQ.smembers(result.kp.anahtar.ssetIndexIhale(anahtar_id));
    }

    function f_db_anahtar_index_ekle_ihale(anahtar_id, ihale_id) {
    ...
    function f_db_anahtar_index_sil_ihale(anahtar_id, ihale_id) {
    ...
    function f_db_anahtar_index_ekle_kalem(anahtar_id, kalem_id) {
    ...
    function f_db_anahtar_index_sil_kalem(anahtar_id, kalem_id) {
