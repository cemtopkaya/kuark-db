...
function DB_Ihale() {
    ...
    function f_paylas(_paylas) {
         ...
         * @returns {*}
         */
        function f_ihale_paylas(_from, _to, _ids) {
    ...
    function f_tahta_ihale_gruplama(_tahta_id, _kurum_id, _onay_durum_id, _para_id, _tarih1, _tarih2) {
     ...
     * @returns {*}
     */
    function f_indexli_tarihine_gore_grupla(_tahta_id, _tarih1, _tarih2) {
     ...
     * @returns {*}
     */
    function f_tarihine_gore_grupla(_tahta_id, _tarih1, _tarih2) {
     ...
     * @returns {*}
     */
    function f_tumu_tarih_araligindakiler(_tahta_id, _tarih1, _tarih2) {
    ...
    function f_teklif_idleri(_tahta_id, _ihale_id, _sayfalama) {
     ...
     * @returns {Promise}
     */
    function f_teklif_tumu(_tahta_id, _ihale_id, _arama) {
     ...
     * @returns {*}
     */
    function f_yapan_kurum(ihale_id) {
     ...
     * @returns {*}
     */
    function f_yapan_kurum_guncelle(ihale_id, kurum_id) {
    ...
    function f_kurum_tumu(tahta_id, ihale_id) {
    ...
    function f_guncellendi_teklif_kontrol(_tahta_id, _eskiIhale_id, _yeniIhale_id) {
     ...
     * @returns {Promise}
     */
    function f_kalem_tumu(ihale_id, tahta_id, opts) {
     ...
     * @returns {*}
     */
    function f_aktif_kalem_idler(_ihale_id, _tahta_id) {
        var defer = result.dbQ.Q.defer();
     ...
     * @returns {*}
     */
    function f_kalemleri_by_page(_ihale_id, _tahta_id, _arama) {
    ...
    function f_sbihale_id(sb_ihale_id) {
     ...
     * @returns {*}
     */
    function f_id(_ihale_id, _tahta_id, _opts) {

        function f_ihale_detaylarini_bagla(_ihale, _optsIhale) {
     ...
     * @returns {*}
     */
    function f_tahta_ihale_idler_aktif(_tahta_id) {
        var defer = result.dbQ.Q.defer();
    ...
    function f_yapilmaTarihi_Araliginda(tarih1_gettime, tarih2_gettime, _tahta_id) {
        ...
        result.dbQ.zrangebyscore([result.kp.ihale.zsetYapilmaTarihi, tarih1_gettime, tarih2_gettime])
            .then(function (_lstIhaleIdler) {
                if (_lstIhaleIdler.length > 0) {
                    ...
                    f_tahta_ihale_idler_aktif(_tahta_id)
    ...
    function f_sistemeEklenmeTarih_Araliginda(tarih1_gettime, tarih2_gettime, _tahta_id) {
    ...
    function _f_arama_kriterinden_ihale_idleri(_arama, _tahta_id) {
        ...
        switch (_arama.Kriter) {
            ...
            case schema.SABIT.URL_QUERY.KRITER.AKTIFLER :
            default:
                defer_kriter = f_tahta_ihale_idler_aktif(_tahta_id);
                break;
        }
     ...
     */
    function f_tahta_ihale_idler_sort_page(_tahta_id, _arama, _opts) {
     ...
     * @returns {Promise}
     */
    function f_ekle(es_ihale, db_ihale, kurum_id, tahta_id, _kul_id) {
     ...
     * @returns {*}
     */
    function f_ekle_genel(_es_ihale, _db_ihale, _kullanici_id) {
         ...
         * @returns {*}
         */
        function f_ihaleEkle(_es_ihale, _db_ihale, _kul_id) {
         ...
         */
        function f_ihaleyiKurumlaIliskilendir(_es_ihale, _db_ihale, _kul_id) {
            _kul_id = _kul_id || _kullanici_id;
        ...
        function f_kalemleriniEkle(_es_ihale, _db_ihale, _kul_id) {
            _kul_id = _kul_id || _kullanici_id;
            // Kalemleri ayıralım
     ...
     * @returns {Promise}
     */
    function f_ekle_ihaleDunyasindan(_es_ihale, _db_ihale, _kul_id) {
    ...
    function f_tahta_ihale_guncelle(es_ihale, _db_ihale, _tahta_id, kurum_id, _kul_id) {
     ...
     * @returns {*}
     */
    function f_kontrol(es_ihale, db_ihale, tahta_id, kurum_id, _kul_id) {
    ...
    function f_tahta_ihale_sil(_ihale_id, _tahta_id, _kul_id) {
     ...
     * @param {integer} _ihale_id
     */
    function f_genel_kontrol(_ihale_id) {
     ...
     * @returns {*}
     */
    function f_guncellendi_satir_kontrol(tahta_id, yeni_ihale_id, orj_ihale_id) {
     ...
     * @returns {*}
     */
    function f_teklifleri(tahta_id, ihale_id) {
        var defer = result.dbQ.Q.defer();
     ...
     * @param {integer} _ihale_id
     */
    function f_tahta_ihale_gizlenen_ekle(_tahta_id, _ihale_id) {
     ...
     * @param {integer} _tahta_id
     */
    function f_tahtanin_gizlenen_ihale_idleri(_tahta_id) {
     ...
     * @param {integer} _tahta_id
     */
    function f_tahtanin_gizlenen_ihaleleri(_ihale_id, _tahta_id) {
     ...
     * @param {integer} _tahta_id
     */
    function f_tahtanin_gizlenen_kalem_idleri(_ihale_id, _tahta_id) {
     ...
     * @param {integer} _tahta_id
     */
    function f_tahtanin_gizlenen_kalemleri(_ihale_id, _tahta_id) {
     ...
     * @param {integer} _ihale_id
     */
    function f_tahta_ihale_takip_sil(_tahta_id, _ihale_id) {
     ...
     * @param {integer} _ihale_id
     */
    function f_tahta_ihale_takip_ekle(_tahta_id, _ihale_id) {
     ...
     * @returns {*}
     */
    function f_takipte_mi(_tahta_id, _ihale) {
     ...
     * @returns {*}
     */
    function f_takip_kontrol(_tahta_id, _ihaleler) {
     ...
     * @param {integer} _tahta_id
     */
    function f_tahtanin_takipteki_ihale_idleri(_tahta_id) {
     ...
     * @param {integer} _tahta_id
     */
    function f_tahtanin_takipteki_ihaleleri(_ihale_id, _tahta_id) {
     ...
     * @returns {*}
     */
    function f_tahtanin_takipteki_kalem_idleri(_ihale_id, _tahta_id) {
    ...
    function f_tahtanin_takipteki_kalemleri(_ihale_id, _tahta_id) {
    ...
    result = {
        ...
        f_db_tahta_ihale_gruplama: f_tahta_ihale_gruplama,
        ...
        f_db_tahta_ihale_idler_aktif: f_tahta_ihale_idler_aktif,
        f_db_tahta_ihale_idler_sort_page: f_tahta_ihale_idler_sort_page,
        f_db_tahta_ihale_takip_ekle: f_tahta_ihale_takip_ekle,
        f_db_tahta_ihale_takip_sil: f_tahta_ihale_takip_sil,
        f_db_tahta_ihale_gizlenen_ekle: f_tahta_ihale_gizlenen_ekle,
        f_db_tahta_ihale_gizlenen_sil: f_tahta_ihale_gizlenen_sil,
        ...
        f_db_tahta_ihale_guncelle: f_tahta_ihale_guncelle,
        f_db_tahta_ihale_sil: f_tahta_ihale_sil,
